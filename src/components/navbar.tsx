...
export default function Navbar() {
  ...
  return (
    <>
      <header
        className={`fixed top-0 left-0 right-0 z-50 shadow-md border-b border-border/20 font-medium text-xl ${
      ...
      >
        <div className="container mx-auto flex items-center justify-between py-4 max-w-screen-xl">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Button
              variant="outline"
              size="lg"
              className="hidden bg-transparent md:inline-flex rounded-full border"
            >
              Coming Soon
            </Button>
            <Button
        ...
        {isMenuOpen && (
          <nav className="md:hidden grid p-4 space-y-2 place-items-center">
